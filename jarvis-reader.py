...
def wishMe():
    ...
    if hour>=0 and hour<12:
        ...
        speak("Good Evening")
    speak("I'm Jarvis. You must be Kartik. Please tell me how may I help you?")
...
def takeInput():
    ...
    elif 'read pdf' in inputStrng:
        inputString = input('Enter Name For File:')
        ms= "D:\OneDrive - Elite academy\Desktop\Jarvis\\"
        # return inputString
        fopen = open(ms+inputString)
        print(fopen.read())
        #webbrowser.open("google.com")
